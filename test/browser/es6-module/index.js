import { createFragment, createElementNs, createElement, setAttributes, createStyleValue } from '../../../dist/browser/es6-module/create-html.debug.js';
...
setAttributes(element, { style: createStyleValue({ color: 'red', 'font-style': 'italic' }) });
